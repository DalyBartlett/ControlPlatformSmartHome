...
//    [self.tabledataview setTableHeaderView:[UIView alloc]];
    ...
    appVersionLabel.text = @"Kelly Jerry";
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(indexPath.row == 1)
    {
        ...
        [mailPicker setToRecipients:[NSArray arrayWithObjects:@"KellyjerryDebeloper@outlook.com",nil]];
...
//        [self presentModalViewController:mailPicker animated:YES];   //
    ...
    {
        NSURL *urlweb = [NSURL URLWithString:@"https://github.com/DalyBartlett/ControlPlatformSmartHome"];
